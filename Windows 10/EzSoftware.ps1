...
$CheckBox21.text                 = "WinFsp"
$CheckBox21.AutoSize             = $false
$CheckBox21.width                = 140
$CheckBox21.height               = 20
$CheckBox21.location             = New-Object System.Drawing.Point(340,200)
$CheckBox21.Font                 = New-Object System.Drawing.Font('Consolas',10)
...
$softwareGroupBox.controls.AddRange(@($CheckBox1,$CheckBox2,$CheckBox3,$CheckBox6,$CheckBox5,$CheckBox4,$CheckBox10,$CheckBox9,$CheckBox7,$CheckBox18,$CheckBox12,$CheckBox11,$CheckBox14,$CheckBox15,$CheckBox17,$CheckBox19,$CheckBox16,$CheckBox21,$CheckBox8,$CheckBox13,$CheckBox20))
...
function NVM {
    try {
        ...
        Start-Process -FilePath $file_path -ArgumentList "/VERYSILENT"
    }
    catch {
...
function Rclone {
    try {
        ...
        $new_path = "$old_path;$rclone_path"
        Set-ItemProperty -Path 'Registry::HKEY_LOCAL_MACHINE\System\CurrentControlSet\Control\Session Manager\Environment' -Name PATH -Value $new_path
        $env:Path += ";$rclone_path"
    }
    catch {
...
function Winaero {
    try {
        ...
        [System.Windows.Forms.MessageBox]::Show("EzSoftware encountered an error!`n`n`Winaero failed to install.", "Task failed!")
    }
}
